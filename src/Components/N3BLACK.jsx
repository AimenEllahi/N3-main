...
export function Model(props) {
  ...
  const [color, setColor] = useState("#537a66");
  ...
  return (
    <group>
        ...
        <Html position={[window.innerWidth < 440 ? -0.3 : 0, 0, -9]}>
          <div className='color-container'>
            ...
            <img
              ...
              onClick={() => setColor("#537a66")}
              className={`color-div ${
                color === "#537a66" && "color-div-selected"
              } `}
            />
            <img
      ...
      <group {...props} dispose={null} ref={groupRef} scale={0.03}>
        <mesh
          geometry={nodes["n3-xiami_name008"].geometry}
          material={materials.Material}
          position={[-21.64, -48.13, 8.43]}
          rotation={[Math.PI / 2, 0, Math.PI]}
        />
        <mesh
          geometry={nodes.CAMERA003.geometry}
          material={materials["my glass.003"]}
          position={[0.55, 0.18, 0.15]}
          rotation={[Math.PI / 2, 0, -Math.PI]}
          scale={10}
        />
        <mesh
       ...
       */}
        ...
        >
          <meshStandardMaterial
            color={activeState === 1 ? color : "#dfebf7"}
            roughness={0.2}
          />
        </mesh>
        <mesh
